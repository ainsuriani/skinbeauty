...
<section class="hero" style="background-image: url('images/banner.jpg');">
    <div class="hero-overlay">
        ...
        <p class="hero-subtitle">Your trusted partner for professional skincare and beauty treatments.</p>
    </div>
</section>
...
<div class="page-content">
    ...
    <div class="intro-section">
        <h3>Welcome to Skin Beauty Clinic</h3>
        <p>At Skin Beauty Clinic, we combine science and artistry to provide top-notch skincare treatments that rejuvenate, nourish, and enhance your natural beauty. Our team of licensed professionals is dedicated to delivering personalized care tailored to your skin's unique needs.</p>
    </div>
    ...
    <div class="mission-grid">
        ...
        <h4>Mission</h4>
        <p>To empower individuals with healthy, radiant skin through professional and innovative skincare solutions.</p>
        </div>
        <div class="mission-card">
        <span class="icon"></span>
        <h4>Vision</h4>
        <p>To become the leading skin beauty clinic known for excellence, safety, and client satisfaction.</p>
        </div>
    </div>
    </section>
...
<section class="history-section">
  ...
  <div class="history-content">
    <p>
      Founded in 2010, Skin Beauty Clinic began with a simple vision: to provide
      safe, effective, and personalized skincare treatments. Over the years, we
      have grown into a trusted name in dermatology and aesthetics, serving
      thousands of clients with dedication and care.
    </p>
    <p>
      From our humble beginnings, we have expanded to multiple branches and
      introduced advanced technologies, ensuring our clients receive world-class
...
<section class="video-section">
  <h3 class="video-title">Clinic Introduction Video</h3>
  <div class="video-wrapper">
    <video id="clinicVideo" width="100%" autoplay loop muted playsinline>
      <source src="video/clinic intro.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>

    <!-- Mute/Unmute Button -->
    <div class="video-controls">
      <button id="muteBtn"><i class="fa-solid fa-volume-mute"></i></button>
    </div>
  </div>
</section>
...
<script>
const video = document.getElementById("clinicVideo");
const muteBtn = document.getElementById("muteBtn");

// Default autoplay muted (browser requirement)
video.muted = true;
...
muteBtn.addEventListener("click", () => {
  ...
  if (video.muted) {
    ...
    <!-- WHY CHOOSE US -->
    <div class="why-us" style="background-image: url('images/clinic-interior.jpg');">
        <div class="why-us-overlay">
            <h3>Why Choose Skin Beauty Clinic?</h3>
            <ul>
                <li>Experienced and licensed skincare professionals</li>
                <li>Personalized treatment plans for every client</li>
                <li>State-of-the-art equipment and safe procedures</li>
                <li>Friendly and welcoming environment</li>
                <li>Proven results with client satisfaction</li>
            </ul>
        </div>
    </div>
    ...
    <div class="cta-section">
        ...
        <p>Book an appointment with us today and experience the ultimate skincare journey.</p>
...
/* MISSION & VISION */
.mission-card {
    background: #eaf4fc;       /* very light blue for card background */
    padding: 25px 20px;
    border-radius: 12px;
    box-shadow: 0 12px 28px rgba(0,0,0,0.08); /* soft shadow */
    text-align: center;
    color: #1a3d7c;            /* dark blue text for readability */
}

.mission-card h4 {
    color: #4a90e2;            /* bright blue heading to stand out */
    margin-bottom: 10px;
}

.mission-card p {
    color: #2a4f88;            /* medium blue for paragraph */
}
...
.history-section h3 {
    color: #4a90e2;            /* bright blue heading */
    margin-bottom: 20px;
}
.history-content p {
    margin-bottom: 15px;
    line-height: 1.6;
    color: #ebebeb;            /* dark blue for easy reading */
}
...
.why-us {
    ...
    border-radius: 12px;
    margin: 50px 0;
    color: #fff;               /* text white on dark overlay */
}
.why-us-overlay {
    background: rgba(0, 72, 150, 0.7); /* semi-transparent dark blue overlay */
    padding: 30px;
    border-radius: 12px;
}
.why-us h3 {
    color: #a6d1ff;            /* light blue heading for contrast */
}
.why-us ul {
    list-style: disc inside;
    margin-top: 15px;
    line-height: 1.6;
    color: #cce6ff;            /* soft blue for list items */
}
