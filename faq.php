...
<section class="hero" style="background-image: url('images/banner.jpg');">
    <div class="hero-overlay">
        ...
        <p class="hero-subtitle">Your questions answered about Skin Beauty Clinic</p>
    </div>
</section>
...
<div class="page-content">
    ...
    <div class="intro-section">
        <!-- Search Bar -->
        <input type="text" id="faqSearch" placeholder="Search questions and please click the chat button below for anything else" style="width:100%; padding:12px; margin-bottom:20px; border-radius:8px; border:1px solid #ccc;">

        <!-- FAQ Accordion -->
        <div class="faq-container">

            <div class="faq-item">
                <button class="faq-question">Do I need an appointment?</button>
                <div class="faq-answer">
                    Yes, booking is recommended to ensure availability and personalized service.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Is consultation safe?</button>
                <div class="faq-answer">
                    Absolutely. All treatments are performed by trained professionals using safe, approved methods.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Can I buy products without booking a treatment?</button>
                <div class="faq-answer">
                    Yes, our shop is open to everyone and you can purchase products anytime.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Are your products suitable for sensitive skin?</button>
                <div class="faq-answer">
                    Yes, we carefully select dermatologist‑approved products safe for all skin types.
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-question">Do you offer packages or memberships?</button>
                <div class="faq-answer">
                    Yes, we offer treatment packages and membership plans for regular clients with discounts.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">How long does a typical facial treatment take?</button>
                <div class="faq-answer">
                    Most facials last between 60 to 90 minutes depending on the treatment type.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Can I reschedule my appointment?</button>
                <div class="faq-answer">
                    Yes, please notify us at least 24 hours in advance to reschedule your appointment.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">What should I do before a treatment?</button>
                <div class="faq-answer">
                    Avoid heavy makeup and harsh skincare products 24 hours prior. Our therapists will guide you.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Do you have male clients?</button>
                <div class="faq-answer">
                    Absolutely! Our treatments are suitable for all genders.
                </div>
            </div>

            <div class="faq-item">
                <button class="faq-question">Are your therapists certified?</button>
                <div class="faq-answer">
                    Yes, all therapists are licensed, trained, and follow strict hygiene and safety protocols.
                </div>
            </div>
...
.hero {
    ...
    padding: 70px 20px;       /* vertical padding */
    text-align: center;
    display: flex;
    align-items: center;
...
document.getElementById('faqSearch').addEventListener('input', function() {
    ...
    document.querySelectorAll('.faq-item').forEach(item => {
        ...
        item.style.display = (questionText.includes(filter) || answerText.includes(filter)) ? '' : 'none';
    });
});
</script>
